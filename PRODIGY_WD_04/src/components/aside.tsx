...
const Aside = () => {
  ...
  const CONTACTS_LIST = [
    {
      title: "Email",
      link: "mailto:charudattabond321@gmail.com",
      icon: <CiMail />,
      value: "charudattabond321@gmail.com",
    },
    {
      title: "LinkedIn",
      link: "https://www.linkedin.com/in/charudatta-bonde-0711271a3/",
      icon: <PiLinkedinLogoLight />,
      value: "Charudatta Bonde",
    },
    {
      title: "Github",
      link: "https://github.com/CharudattaB",
